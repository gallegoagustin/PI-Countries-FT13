...
() {
    return (
        <div className={styles.boxContainer}>
            ...
            <p>Not only you can <strong>search for countries</strong> and <strong>add activities</strong> but also ordering or filtering them by name and kind of activity if necessary.</p>
